...
, active      { false }
{
    ...
    //: It must have exactly the same translation as other 'dpi' in this file
	dpi_combo->setValidator(new QRegExpValidator(QRegExp(QString::fromLatin1("^[1-9]\\d{1,4}$|^[1-9]\\d{1,4} ")+tr("dpi")+QString::fromLatin1("$")), dpi_combo));
