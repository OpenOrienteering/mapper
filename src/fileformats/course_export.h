...
public:
	...
	//bool canExport(const std::vector<ControlPoint>& controls);
    ...
    void setProperties(Map& map, const QString& event_name, const QString& course_name, const QString& start_symbol, const QString& finish_symbol);
