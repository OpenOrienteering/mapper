...
{
	// TODO: save directory
	QString path = QFileDialog::getOpenFileName(dialog_parent, tr("Open image or GPS track ..."), QString(), QString("%1 (*.bmp *.jpg *.jpeg *.gif *.png *.tiff *.gpx);;%2 (*.*)").arg(tr("Template files")).arg(tr("All files")));
