	...
	if (adjust_other_coords && part.getNumCoords() >= 2)
	{
		...
		if (old_coord.isCurveStart())
		{
			if ((pos - part.start_index >= 3 && coords[pos - 3].isCurveStart()) || (part.isClosed() && part.getNumCoords() >= 4 && shiftedCoord(pos, -3, part).isCurveStart()))
			{
				...
				E = int((Zx - subs(Xx, u, 2*w))^2 + (Zy - subs(Xy, u, 2*w))^2, w, 0, 1/2) + int((Zx - subs(Yx, v, 2*w - 1))^2 + (Zy - subs(Yy, v, 2*w - 1))^2, w, 1/2, 1);
				...
				*/
				...
				double pfactor = (168*P0x*pow(Q2x,3.0) - 91*P0x*pow(Q3x,3.0) - 168*P1x*pow(Q2x,3.0) + 91*P1x*pow(Q3x,3.0) + 168*P0y*pow(Q2y,3.0) - 91*P0y*pow(Q3y,3.0) - 168*P1y*pow(Q2y,3.0) + 91*P1y*pow(Q3y,3.0) + 581*pow(P0x,2.0)*pow(Q2x,2.0) + 581*pow(P0x,2.0)*pow(Q3x,2.0) + 294*pow(P1x,2.0)*pow(Q2x,2.0) + 294*pow(P1x,2.0)*pow(Q3x,2.0) + 1172*pow(P0x,2.0)*pow(Q2y,2.0) + 1172*pow(P0y,2.0)*pow(Q2x,2.0) + 1172*pow(P0x,2.0)*pow(Q3y,2.0) + 384*pow(P1x,2.0)*pow(Q2y,2.0) + 1172*pow(P0y,2.0)*pow(Q3x,2.0) + 384*pow(P1y,2.0)*pow(Q2x,2.0) + 384*pow(P1x,2.0)*pow(Q3y,2.0) + 384*pow(P1y,2.0)*pow(Q3x,2.0) + 581*pow(P0y,2.0)*pow(Q2y,2.0) + 581*pow(P0y,2.0)*pow(Q3y,2.0) + 294*pow(P1y,2.0)*pow(Q2y,2.0) + 294*pow(P1y,2.0)*pow(Q3y,2.0) - 875*P0x*P1x*pow(Q2x,2.0) - 875*P0x*P1x*pow(Q3x,2.0) - 294*P0x*P2x*pow(Q2x,2.0) - 294*P0x*P2x*pow(Q3x,2.0) - 196*P0x*P3x*pow(Q2x,2.0) + 294*P1x*P2x*pow(Q2x,2.0) - 196*P0x*P3x*pow(Q3x,2.0) + 294*P1x*P2x*pow(Q3x,2.0) + 196*P1x*P3x*pow(Q2x,2.0) + 196*P1x*P3x*pow(Q3x,2.0) - 1556*P0x*P1x*pow(Q2y,2.0) - 1556*P0x*P1x*pow(Q3y,2.0) - 456*P0x*P2x*pow(Q2y,2.0) - 456*P0x*P2x*pow(Q3y,2.0) - 784*P0x*P3x*pow(Q2y,2.0) + 456*P1x*P2x*pow(Q2y,2.0) - 784*P0x*P3x*pow(Q3y,2.0) + 456*P1x*P2x*pow(Q3y,2.0) + 784*P1x*P3x*pow(Q2y,2.0) + 784*P1x*P3x*pow(Q3y,2.0) - 1556*P0y*P1y*pow(Q2x,2.0) - 1556*P0y*P1y*pow(Q3x,2.0) - 456*P0y*P2y*pow(Q2x,2.0) - 456*P0y*P2y*pow(Q3x,2.0) - 784*P0y*P3y*pow(Q2x,2.0) + 456*P1y*P2y*pow(Q2x,2.0) - 784*P0y*P3y*pow(Q3x,2.0) + 456*P1y*P2y*pow(Q3x,2.0) + 784*P1y*P3y*pow(Q2x,2.0) + 784*P1y*P3y*pow(Q3x,2.0) - 875*P0y*P1y*pow(Q2y,2.0) - 875*P0y*P1y*pow(Q3y,2.0) - 294*P0y*P2y*pow(Q2y,2.0) - 294*P0y*P2y*pow(Q3y,2.0) - 196*P0y*P3y*pow(Q2y,2.0) + 294*P1y*P2y*pow(Q2y,2.0) - 196*P0y*P3y*pow(Q3y,2.0) + 294*P1y*P2y*pow(Q3y,2.0) + 196*P1y*P3y*pow(Q2y,2.0) + 196*P1y*P3y*pow(Q3y,2.0) + 126*P0x*Q1x*pow(Q2x,2.0) + 126*P0x*Q1x*pow(Q3x,2.0) - 126*P1x*Q1x*pow(Q2x,2.0) + 350*P0x*Q2x*pow(Q3x,2.0) - 427*P0x*pow(Q2x,2.0)*Q3x - 126*P1x*Q1x*pow(Q3x,2.0) - 1162*pow(P0x,2.0)*Q2x*Q3x - 350*P1x*Q2x*pow(Q3x,2.0) + 427*P1x*pow(Q2x,2.0)*Q3x - 588*pow(P1x,2.0)*Q2x*Q3x - 216*P0x*Q1x*pow(Q2y,2.0) - 216*P0x*Q1x*pow(Q3y,2.0) + 168*P0x*Q2x*pow(Q2y,2.0) + 216*P1x*Q1x*pow(Q2y,2.0) + 759*P0x*Q2x*pow(Q3y,2.0) + 500*P0x*Q3x*pow(Q2y,2.0) + 216*P1x*Q1x*pow(Q3y,2.0) - 168*P1x*Q2x*pow(Q2y,2.0) - 2344*pow(P0y,2.0)*Q2x*Q3x - 91*P0x*Q3x*pow(Q3y,2.0) - 759*P1x*Q2x*pow(Q3y,2.0) - 500*P1x*Q3x*pow(Q2y,2.0) - 768*pow(P1y,2.0)*Q2x*Q3x + 91*P1x*Q3x*pow(Q3y,2.0) - 216*P0y*pow(Q2x,2.0)*Q1y + 168*P0y*pow(Q2x,2.0)*Q2y - 216*P0y*pow(Q3x,2.0)*Q1y + 216*P1y*pow(Q2x,2.0)*Q1y + 500*P0y*pow(Q2x,2.0)*Q3y + 759*P0y*pow(Q3x,2.0)*Q2y - 168*P1y*pow(Q2x,2.0)*Q2y + 216*P1y*pow(Q3x,2.0)*Q1y - 2344*pow(P0x,2.0)*Q2y*Q3y - 91*P0y*pow(Q3x,2.0)*Q3y - 500*P1y*pow(Q2x,2.0)*Q3y - 759*P1y*pow(Q3x,2.0)*Q2y - 768*pow(P1x,2.0)*Q2y*Q3y + 91*P1y*pow(Q3x,2.0)*Q3y + 126*P0y*Q1y*pow(Q2y,2.0) + 126*P0y*Q1y*pow(Q3y,2.0) - 126*P1y*Q1y*pow(Q2y,2.0) + 350*P0y*Q2y*pow(Q3y,2.0) - 427*P0y*pow(Q2y,2.0)*Q3y - 126*P1y*Q1y*pow(Q3y,2.0) - 1162*pow(P0y,2.0)*Q2y*Q3y - 350*P1y*Q2y*pow(Q3y,2.0) + 427*P1y*pow(Q2y,2.0)*Q3y - 588*pow(P1y,2.0)*Q2y*Q3y + 1750*P0x*P1x*Q2x*Q3x + 588*P0x*P2x*Q2x*Q3x + 392*P0x*P3x*Q2x*Q3x - 588*P1x*P2
y*Q1x*Q3x*Q2y + 432*P0y*Q2x*Q3x*Q1y - 342*P1y*Q1x*Q2x*Q2y - 927*P0x*Q2x*Q2y*Q3y + 342*P0x*Q3x*Q1y*Q3y - 432*P1x*Q1x*Q2y*Q3y + 342*P1x*Q2x*Q1y*Q3y + 342*P1x*Q3x*Q1y*Q2y + 342*P0y*Q1x*Q3x*Q3y - 927*P0y*Q2x*Q3x*Q2y + 342*P1y*Q1x*Q2x*Q3y + 342*P1y*Q1x*Q3x*Q2y - 432*P1y*Q2x*Q3x*Q1y - 409*P0x*Q3x*Q2y*Q3y + 927*P1x*Q2x*Q2y*Q3y - 342*P1x*Q3x*Q1y*Q3y - 409*P0y*Q2x*Q3x*Q3y - 342*P1y*Q1x*Q3x*Q3y + 927*P1y*Q2x*Q3x*Q2y + 409*P1x*Q3x*Q2y*Q3y + 409*P1y*Q2x*Q3x*Q3y - 252*P0y*Q1y*Q2y*Q3y + 252*P1y*Q1y*Q2y*Q3y)/(48*(7*pow(P0x,2.0)*pow(Q2x,2.0) - 14*pow(P0x,2.0)*Q2x*Q3x + 7*pow(P0x,2.0)*pow(Q3x,2.0) + 16*pow(P0x,2.0)*pow(Q2y,2.0) - 32*pow(P0x,2.0)*Q2y*Q3y + 16*pow(P0x,2.0)*pow(Q3y,2.0) - 14*P0x*P1x*pow(Q2x,2.0) + 28*P0x*P1x*Q2x*Q3x - 14*P0x*P1x*pow(Q3x,2.0) - 32*P0x*P1x*pow(Q2y,2.0) + 64*P0x*P1x*Q2y*Q3y - 32*P0x*P1x*pow(Q3y,2.0) - 18*P0x*P0y*Q2x*Q2y + 18*P0x*P0y*Q2x*Q3y + 18*P0x*P0y*Q3x*Q2y - 18*P0x*P0y*Q3x*Q3y + 18*P0x*P1y*Q2x*Q2y - 18*P0x*P1y*Q2x*Q3y - 18*P0x*P1y*Q3x*Q2y + 18*P0x*P1y*Q3x*Q3y + 7*pow(P1x,2.0)*pow(Q2x,2.0) - 14*pow(P1x,2.0)*Q2x*Q3x + 7*pow(P1x,2.0)*pow(Q3x,2.0) + 16*pow(P1x,2.0)*pow(Q2y,2.0) - 32*pow(P1x,2.0)*Q2y*Q3y + 16*pow(P1x,2.0)*pow(Q3y,2.0) + 18*P1x*P0y*Q2x*Q2y - 18*P1x*P0y*Q2x*Q3y - 18*P1x*P0y*Q3x*Q2y + 18*P1x*P0y*Q3x*Q3y - 18*P1x*P1y*Q2x*Q2y + 18*P1x*P1y*Q2x*Q3y + 18*P1x*P1y*Q3x*Q2y - 18*P1x*P1y*Q3x*Q3y + 16*pow(P0y,2.0)*pow(Q2x,2.0) - 32*pow(P0y,2.0)*Q2x*Q3x + 16*pow(P0y,2.0)*pow(Q3x,2.0) + 7*pow(P0y,2.0)*pow(Q2y,2.0) - 14*pow(P0y,2.0)*Q2y*Q3y + 7*pow(P0y,2.0)*pow(Q3y,2.0) - 32*P0y*P1y*pow(Q2x,2.0) + 64*P0y*P1y*Q2x*Q3x - 32*P0y*P1y*pow(Q3x,2.0) - 14*P0y*P1y*pow(Q2y,2.0) + 28*P0y*P1y*Q2y*Q3y - 14*P0y*P1y*pow(Q3y,2.0) + 16*pow(P1y,2.0)*pow(Q2x,2.0) - 32*pow(P1y,2.0)*Q2x*Q3x + 16*pow(P1y,2.0)*pow(Q3x,2.0) + 7*pow(P1y,2.0)*pow(Q2y,2.0) - 14*pow(P1y,2.0)*Q2y*Q3y + 7*pow(P1y,2.0)*pow(Q3y,2.0)));
				double qfactor = (91*pow(P0x,3.0)*Q2x - 91*pow(P0x,3.0)*Q3x - 168*pow(P1x,3.0)*Q2x + 168*pow(P1x,3.0)*Q3x + 91*pow(P0y,3.0)*Q2y - 91*pow(P0y,3.0)*Q3y - 168*pow(P1y,3.0)*Q2y + 168*pow(P1y,3.0)*Q3y + 294*pow(P0x,2.0)*pow(Q2x,2.0) + 581*pow(P0x,2.0)*pow(Q3x,2.0) + 294*pow(P1x,2.0)*pow(Q2x,2.0) + 581*pow(P1x,2.0)*pow(Q3x,2.0) + 384*pow(P0x,2.0)*pow(Q2y,2.0) + 384*pow(P0y,2.0)*pow(Q2x,2.0) + 1172*pow(P0x,2.0)*pow(Q3y,2.0) + 384*pow(P1x,2.0)*pow(Q2y,2.0) + 1172*pow(P0y,2.0)*pow(Q3x,2.0) + 384*pow(P1y,2.0)*pow(Q2x,2.0) + 1172*pow(P1x,2.0)*pow(Q3y,2.0) + 1172*pow(P1y,2.0)*pow(Q3x,2.0) + 294*pow(P0y,2.0)*pow(Q2y,2.0) + 581*pow(P0y,2.0)*pow(Q3y,2.0) + 294*pow(P1y,2.0)*pow(Q2y,2.0) + 581*pow(P1y,2.0)*pow(Q3y,2.0) - 588*P0x*P1x*pow(Q2x,2.0) + 427*P0x*pow(P1x,2.0)*Q2x - 350*pow(P0x,2.0)*P1x*Q2x - 1162*P0x*P1x*pow(Q3x,2.0) - 427*P0x*pow(P1x,2.0)*Q3x + 350*pow(P0x,2.0)*P1x*Q3x - 126*pow(P0x,2.0)*P2x*Q2x + 126*pow(P0x,2.0)*P2x*Q3x + 196*pow(P0x,2.0)*P3x*Q2x - 126*pow(P1x,2.0)*P2x*Q2x - 196*pow(P0x,2.0)*P3x*Q3x + 126*pow(P1x,2.0)*P2x*Q3x + 196*pow(P1x,2.0)*P3x*Q2x - 196*pow(P1x,2.0)*P3x*Q3x + 91*P0x*pow(P0y,2.0)*Q2x - 768*P0x*P1x*pow(Q2y,2.0) - 91*P0x*pow(P0y,2.0)*Q3x - 500*P0x*pow(P1y,2.0)*Q2x - 759*P1x*pow(P0y,2.0)*Q2x - 2344*P0x*P1x*pow(Q3y,2.0) + 500*P0x*pow(P1y,2.0)*Q3x + 759*P1x*pow(P0y,2.0)*Q3x - 168*P1x*pow(P1y,2.0)*Q2x + 216*P2x*pow(P0y,2.0)*Q2x + 168*P1x*pow(P1y,2.0)*Q3x - 216*P2x*pow(P0y,2.0)*Q3x + 216*P2x*pow(P1y,2.0)*Q2x + 784*P3x*pow(P0y,2.0)*Q2x - 216*P2x*pow(P1y,2.0)*Q3x - 784*P3x*pow(P0y,2.0)*Q3x + 784*P3x*pow(P1y,2.0)*Q2x - 784*P3x*pow(P1y,2.0)*Q3x + 91*pow(P0x,2.0)*P0y*Q2y - 768*P0y*P1y*pow(Q2x,2.0) - 91*pow(P0x,2.0)*P0y*Q3y - 759*pow(P0x,2.0)*P1y*Q2y - 500*pow(P1x,2.0)*P0y*Q2y - 2344*P0y*P1y*pow(Q3x,2.0) + 759*pow(P0x,2.0)*P1y*Q3y + 216*pow(P0x,2.0)*P2y*Q2y + 500*pow(P1x,2.0)*P0y*Q3y - 168*pow(P1x,2.0)*P1y*Q2y - 216*pow(P0x,2.0)*P2y*Q3y + 784*pow(P0x,2.0)*P3y*Q2y + 168*pow(P1x,2.0)*P1y*Q3y + 216*pow(P1x,2.0)*P2y*Q2y - 784*pow(P0x,2.0)*P3y*Q3y - 216*pow(P1x,2.0)*P2y*Q3y + 784*pow(P1x,2.0)*P3y*Q2y - 784*pow(P1x,2.0)*P3y*Q3y - 588*P0y*P1y*pow(Q2y,2.0) + 427*P0y*pow(P1y,2.0)*Q2y - 350*pow(P0y,2.0)*P1y*Q2y - 1162*P0y*P1y*pow(Q3y,2.0) - 427*P0y*pow(P1y,2.0)*Q3y + 350*pow(P0y,2.0)*P1y*Q3y - 126*pow(P0y,2.0)*P2y*Q2y + 126*pow(P0y,2.0)*P2y*Q3y + 196*pow(P0y,2.0)*P3y*Q2y - 126*pow(P1y,2.0)*P2y*Q2y - 196*pow(P0y,2.0)*P3y*Q3y + 126*pow(P1y,2.0)*P2y*Q3y + 196*pow(P1y,2.0)*P3y*Q2y - 196*pow(P1y,2.0)*P3y*Q3y + 294*pow(P0x,2.0)*Q1x*Q2x - 294*pow(P0x,2.0)*Q1x*Q3x + 294*pow(P1x,2.0)*Q1x*Q2x - 875*pow(P0x,2.0)*Q2x*Q3x - 294*pow(P1x,2.0)*Q1x*Q3x - 875*pow(P1x,2.0)*Q2x*Q3x + 456*pow(P0y,2.0)*Q1x*Q2x - 456*pow(P0y,2.0)*Q1x*Q3x + 456*pow(P1y,2.0)*Q1x*Q2x - 1556*pow(P0y,2.0)*Q2x*Q3x - 456*pow(P1y,2.0)*Q1x*Q3x - 1556*pow(P1y,2.0)*Q2x*Q3x + 456*pow(P0x,2.0)*Q1y*Q2y - 456*pow(P0x,2.0)*Q1y*Q3y + 456*pow(P1x,2.0)*Q1y*Q2y - 1556*pow(P0x,2.0)*Q2y*Q3y - 456*pow(P1x,2.0)*Q1y*Q3y - 1556*pow(P1x,2.0)*Q2y*Q3y + 294*pow(P0y,2.0)*Q1y*Q2y - 294*pow(P0y,2.0)*Q1y*Q3y + 294*pow(P1y,2.0)*Q1y*Q2y - 875*pow(P0y,2.0)*Q2y*Q3y - 294*pow(P1y,2.0)*Q1y*Q3y - 875*pow(P1y,2.0)*Q2y*Q3y + 252*P0x*P1x*P2x*Q2x - 252*P0x*P1x*P2x*Q3x - 392*P0x*P1x*P3x*Q2x + 392*P0x*P1x*P3x*Q3x + 409*P0x*P1x*P0y*Q2y + 409*P0x*P0y*P1y*Q2x - 409*P0x*P1x*P0y*Q3y + 927*P0x*P1x*P1y*Q2y - 342*P0x*P2x*P0y*Q2y - 
*Q2y - 681*P1x*P0y*Q2x*Q3y - 681*P1x*P0y*Q3x*Q2y + 162*P1x*P1y*Q1x*Q3y - 180*P1x*P1y*Q2x*Q2y + 162*P1x*P1y*Q3x*Q1y + 3112*P0y*P1y*Q2x*Q3x + 1182*P0x*P1y*Q3x*Q3y + 1182*P1x*P0y*Q3x*Q3y + 681*P1x*P1y*Q2x*Q3y + 681*P1x*P1y*Q3x*Q2y - 1182*P1x*P1y*Q3x*Q3y - 588*P0y*P1y*Q1y*Q2y + 588*P0y*P1y*Q1y*Q3y + 1750*P0y*P1y*Q2y*Q3y)/(48*(7*pow(P0x,2.0)*pow(Q2x,2.0) - 14*pow(P0x,2.0)*Q2x*Q3x + 7*pow(P0x,2.0)*pow(Q3x,2.0) + 16*pow(P0x,2.0)*pow(Q2y,2.0) - 32*pow(P0x,2.0)*Q2y*Q3y + 16*pow(P0x,2.0)*pow(Q3y,2.0) - 14*P0x*P1x*pow(Q2x,2.0) + 28*P0x*P1x*Q2x*Q3x - 14*P0x*P1x*pow(Q3x,2.0) - 32*P0x*P1x*pow(Q2y,2.0) + 64*P0x*P1x*Q2y*Q3y - 32*P0x*P1x*pow(Q3y,2.0) - 18*P0x*P0y*Q2x*Q2y + 18*P0x*P0y*Q2x*Q3y + 18*P0x*P0y*Q3x*Q2y - 18*P0x*P0y*Q3x*Q3y + 18*P0x*P1y*Q2x*Q2y - 18*P0x*P1y*Q2x*Q3y - 18*P0x*P1y*Q3x*Q2y + 18*P0x*P1y*Q3x*Q3y + 7*pow(P1x,2.0)*pow(Q2x,2.0) - 14*pow(P1x,2.0)*Q2x*Q3x + 7*pow(P1x,2.0)*pow(Q3x,2.0) + 16*pow(P1x,2.0)*pow(Q2y,2.0) - 32*pow(P1x,2.0)*Q2y*Q3y + 16*pow(P1x,2.0)*pow(Q3y,2.0) + 18*P1x*P0y*Q2x*Q2y - 18*P1x*P0y*Q2x*Q3y - 18*P1x*P0y*Q3x*Q2y + 18*P1x*P0y*Q3x*Q3y - 18*P1x*P1y*Q2x*Q2y + 18*P1x*P1y*Q2x*Q3y + 18*P1x*P1y*Q3x*Q2y - 18*P1x*P1y*Q3x*Q3y + 16*pow(P0y,2.0)*pow(Q2x,2.0) - 32*pow(P0y,2.0)*Q2x*Q3x + 16*pow(P0y,2.0)*pow(Q3x,2.0) + 7*pow(P0y,2.0)*pow(Q2y,2.0) - 14*pow(P0y,2.0)*Q2y*Q3y + 7*pow(P0y,2.0)*pow(Q3y,2.0) - 32*P0y*P1y*pow(Q2x,2.0) + 64*P0y*P1y*Q2x*Q3x - 32*P0y*P1y*pow(Q3x,2.0) - 14*P0y*P1y*pow(Q2y,2.0) + 28*P0y*P1y*Q2y*Q3y - 14*P0y*P1y*pow(Q3y,2.0) + 16*pow(P1y,2.0)*pow(Q2x,2.0) - 32*pow(P1y,2.0)*Q2x*Q3x + 16*pow(P1y,2.0)*pow(Q3x,2.0) + 7*pow(P1y,2.0)*pow(Q2y,2.0) - 14*pow(P1y,2.0)*Q2y*Q3y + 7*pow(P1y,2.0)*pow(Q3y,2.0)));
