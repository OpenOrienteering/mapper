...
public:
	...
	/** Calculates 'paper' area of area objects in mm. */
	double getPaperArea() const;
	
	/** Calculates 'real' area of area objects in m. */
	double getRealArea() const;
	
	/** Returns true if 'paper' area of an area object is smaller than the specified minimum area of the object's symbol. */
	bool isAreaTooSmall() const;
	
	/** Returns true if 'paper' length of a path object is shorter than the specified minimum length of the object's symbol. */
