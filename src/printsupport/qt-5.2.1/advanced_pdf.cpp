...
void AdvancedPdfEnginePrivate::setPaperSize(const QSizeF &pageSizeMM)
{
...
QRect AdvancedPdfEnginePrivate::paperRect() const
{
...
QRect AdvancedPdfEnginePrivate::pageRect() const
{
    QRect r = paperRect();
