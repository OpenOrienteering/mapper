...
protected:
	...
	void advanceCoordinateRangeTo(const MapCoordVector& flags, const MapCoordVectorF& coords, const PathCoordVector& line_coords, int& cur_path_coord, int& current_index, float cur_length,
