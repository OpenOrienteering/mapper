...
Contours shall be adapted or broken in order not to touch symbol Small knoll (109) or Small elongated knoll (110).</source>
        ...
        <translation type="unfinished">Линия, свързваща точки с еднаква височина. Стандартният вертикален интервал между контурите е 5 м. За равни терени може да се използва интервал между контурите от 2,5 м.
...
Minimum length: two dashes (3.65 mm - footprint 55 m). If shorter, the object must be exaggerated to the minimum length or changed to symbol Earth wall (105).</source>
        ...
        <translation>Разрушена или по-малко отчетлива земна стена. Минимална височина: 0,5 м.
Минимална дължина: две чертички (3,65 мм - отпечатък 55 м). Ако е по-къс, обектът трябва да бъде увеличен до минималната дължина или променен на символ Земна стена (105).</translation>
    </message>
    <message>
...
Minimum length: 1.15 mm (footprint 17.25 m).</source>
        ...
        <translation type="unfinished">Ерозионно дере, което е твърде малко, за да бъде показано със символа Земен насип (104), е показано с една линия. Минимална дълбочина: 1 м.
...
Contour lines shall be broken around this symbol.</source>
        ...
        <translation type="unfinished">Малък ерозирало дере, сух ров или изкоп. Минимална дълбочина: 0,5 м.
Минимална дължина (изолирана): три точки (1,15 мм - отпечатък 17 м).
Контурните линии трябва да бъдат прекъснати около този символ.</translation>
    </message>
    <message>
...
Footprint: 12 m x 6 m.</source>
        ...
        <translation>Ясно видим удължен хълм, който не може да се изобрази в мащаб с контур.
Минимална височина: 1 м.
Символът не трябва да докосва или да се припокрива с контури.
...
Footprint: 10.5 m x 12 m.</source>
        ...
        <translation>Ями и дупки с ясно изразени стръмни страни, които не могат да бъдат показани в мащаб с помощта на символа Земен насип (104).
Минимална дълбочина: 1 м, минимална ширина: 1 м.
Яма, по-голяма от 5 м x 5 м, обикновено трябва да бъде увеличена и изчертана с помощта на символа Земен насип (104). Ями без стръмни страни се представят със символа Малка вдлъбнатина (111).
Символът не трябва да докосва или да се припокрива с други кафяви символи. Местоположението е центърът на тежестта на символа и символът е ориентиран на север.
Площ на основата: 10,5 м x 12 м.</translation>
    </message>
    <message>
...
The dots shall not be arranged to form a single point wide line.</source>
        ...
        <translation>Зона с ями и/или хълмове, която е твърде сложна, за да бъде показана подробно, или други видове неравен и груб терен, който е ясно различим, но има малко влияние върху проходимостта.
Точките трябва да бъдат разпределени на случаен принцип, но да не пречат на представянето на важни характеристики и обекти на терена.
Минималният брой точки е три (отпечатък 10 м x 10 м).
Максималното разстояние между центрове и съседните точки е 0,6 мм.
Минималното разстояние между центрове и съседните точки е 0,5 мм.
Контурите не трябва да се изрязват в райони с нарушен терен.
Точките не трябва да бъдат разположени така, че да образуват линия с ширина от една точка.</translation>
    </message>
    <message>
...
Максималното разстояние между центрове и съседните точки е 0,6 мм.
Минималното разстояние между центрове и съседните точки е 0,5 мм.
Контурите не трябва да се изрязват в нарушени теренни зони.
Точките не трябва да бъдат разположени така, че да образуват линия с една точка.
Плътност: 3-4 точки/мм².</translation>
    </message>
    <message>
...
The dots shall not be arranged to form a single point wide line.</source>
        ...
        <translation>Зона с ями и/или хълмове, която е твърде сложна, за да бъде показана подробно, или други видове неравен и груб терен, който е ясно различим и влияе върху проходимостта.
Точките трябва да бъдат разпределени на случаен принцип, но да не пречат на представянето на важни характеристики и обекти на терена.
Минималният брой точки е три (отпечатък 7 м x 7 м).
Максималното разстояние между центрове и съседните точки е 0,38 мм.
...
Footprint: 13.5 m x 11.5 m.</source>
        ...
        <translation>Обектът трябва да бъде много ясно различим от околността.
Местоположението е центърът на тежестта на символа, който е ориентиран на север.
Символът не трябва да докосва или да се припокрива с други кафяви символи.
Определението на символа трябва да бъде дадено на картата.
 Площ: 13,5 м x 11,5 м.</translation>
    </message>
    <message>
...
Minimum length: 0.6 mm (footprint 9 m).</source>
        ...
        <translation type="unfinished">Проходима скала или кариера. Ако посоката на падане на скалата не е видима от контурите или за да се подобри четливостта, могат да се начертаят кратки етикети в посока надолу по склона.
...
Contour lines should be broken around this symbol.</source>
        <comment>Description of symbol 108</comment>
        <translation type="obsolete">Малък ерозирало дере, сух ров или изкоп. Минимална дълбочина: 0,5 м.
Минимална дължина (изолирана): три точки (1,15 мм - отпечатък 17 м).
Контурните линии трябва да бъдат прекъснати около този символ.</translation>
    </message>
    <message>
