...
The purple line will extend a bit into the finish symbol. This is a shortcoming of this simple approach.</source>
    ...
    <context>
        ...
        <message>
            ...
            <translation>Крутой перегиб поверхности земли, однозначно выделяющийся из окружающей среды. Гравийные или песчаные выработки, дорожные выемки и насыпи и т. п. Зубцы должны показывать полную проекцию склона, но могут быть опущены, если два обрыва располагаются близко друг от друга. Опасные грунтовые обрывы показываются ззнаком 201.</translation>
        </message>
        <message>
